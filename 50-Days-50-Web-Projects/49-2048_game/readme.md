...
[![GSSoC 2026](https://img.shields.io/badge/GSSoC-2026-F96F36?style=for-the-badge&logo=girlscript)](https://github.com/chaitanya-suddamalla)
[![GitHub Profile](https://img.shields.io/badge/GitHub-chaitanya-suddamalla-181717?style=for-the-badge&logo=github)](https://github.com/chaitanya-suddamalla)
...
- **Combo Streaks & Confetti:** Consecutive merges trigger escalating text labels (_"3× combo!" → "On fire!" → "Unstoppable!" → "LEGENDARY!"_). Reaching 2048 fires a full canvas-based confetti shower.
...
4. _No build tools, no dependencies, and no internet connection required (except to load the Google Font)._
