...
```bash
# Repository and contributor details: https://github.com/chaitanya-suddamalla
```

2. Open the project folder

```bash
# Open the repository folder inside the 50_days_50_web_projects collection
```
...
Original Repository: https://github.com/chaitanya-suddamalla
