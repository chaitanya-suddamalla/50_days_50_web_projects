...
for path in files_to_patch:
    ...
    text = text.replace('50 Days 50 Web Projects', '50 Days 50 Web Projects')
    text = text.replace('50-days-50-web-project.vercel.app', '50-days-50-web-project.vercel.app')
    text = text.replace('50-days-50-web-projects', '50-days-50-web-projects')
    text = text.replace('50-days-50-web-project', '50-days-50-web-project')
    text = text.replace('https://github.com/ChaitanyaSuddamalla/50-days-50-web-projects.git', 'https://github.com/chaitanya-suddamalla/50-days-50-web-projects.git')
    text = text.replace('https://github.com/ChaitanyaSuddamalla/50-days-50-web-projects', 'https://github.com/chaitanya-suddamalla/50-days-50-web-projects')
    text = text.replace('https://github.com/chaitanya-suddamalla/50-days-50-web-projects.git', 'https://github.com/chaitanya-suddamalla/50-days-50-web-projects.git')
    text = text.replace('https://github.com/chaitanya-suddamalla/50-days-50-web-projects', 'https://github.com/chaitanya-suddamalla/50-days-50-web-projects')
    text = text.replace('https://github.com/ChaitanyaSuddamalla/50-days-50-web-projects', 'https://github.com/chaitanya-suddamalla/50-days-50-web-projects')
    text = text.replace('https://github.com/ChaitanyaSuddamalla/50-days-50-web-projects.git', 'https://github.com/chaitanya-suddamalla/50-days-50-web-projects.git')
...
pkg = pkg.replace('"name": "50-days-50-web-projects"', '"name": "50-days-50-web-projects"')
pkg_path.write_text(pkg, encoding='utf-8')
lock_path = root / 'package-lock.json'
if lock_path.exists():
    lock = lock_path.read_text(encoding='utf-8')
    lock = lock.replace('"name": "50-days-50-web-projects"', '"name": "50-days-50-web-projects"')
