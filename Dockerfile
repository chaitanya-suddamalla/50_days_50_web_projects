# ============================================================================
# 50 Days 50 Web Projects — Docker Container
# Serves the static site using Nginx Alpine for minimal image size
# ============================================================================

FROM nginx:1.27-alpine AS production

LABEL maintainer="50 Days 50 Web Projects Contributors"
LABEL description="Static site showcase of curated web projects"
LABEL org.opencontainers.image.source="https://github.com/chaitanya-suddamalla/50_days_50_web_projects"
